...
<div class="container">
    <div class="sidenav" >
        ...
        <a href="http://lmdms-orpai.herokuapp.com/" ><i class="fa-solid fa-dashboard fa-lg" style="padding-right: 14px;"></i> Dashboard</a>
...
{{--            <i class="fa-solid fa-plus fa-lg"></i>--}}
        ...
        <button class="dropdown-btn" style="outline:0;"> <i class="fa-solid fa-user-tie fa-lg" style="padding-right: 3px; padding-left: 4px;"></i> &nbsp;&nbsp;UserA (Manager)<i class="fa fa-caret-down"></i>
        </button>
        <div class="dropdown-container" >
            <a href="#" style="font-size: 14px;"><i class="fa-solid fa-eye fa-lg"></i> &nbsp;&nbsp;View Profile</a>
            <a href="#" style="font-size: 14px;"><i class="fas fa-user-edit fa-lg"></i> &nbsp;&nbsp;Edit Profile</a>
            <a href="#" style="font-size: 14px;"><i class="fa-solid fa-right-from-bracket fa-lg"></i> &nbsp;&nbsp;&nbsp;Log out</a>
